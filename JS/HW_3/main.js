...
for (let i = 0; i < 10; i++) {
    document.write('<div>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti, eligendi?</div>');
}

// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині

for (let i = 0; i < 10; i++) {
    document.write(`<div>index: ${i} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deleniti, eligendi?</div>`);
}
...
let i = 0;
while (i<20){
    document.write('<h1>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, illum!</h1>')
    ++i;
}
...
let j = 0;
while (j<20){
    document.write(`<h1>index:${j} Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequuntur, illum!</h1>`)
    ++j;
}
