...
// - Є масив:
let m = ['Main', 'Products', 'About us', 'Contacts'];
...
for (const simpson of simpsons) {
    let div = document.createElement('div');
    div.classList.add(`member-${simpson.name}`);
    document.body.appendChild(div);
    ...
    div.append(name, age, info, photo);
...
for (const course of coursesArray) {
    ...
    courseWrap.append(title, duration, modules);
}
